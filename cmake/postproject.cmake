...
if(LITE_WITH_OPENMP)
    if (ARM_TARGET_LANG STREQUAL "gcc" OR (ARM_TARGET_LANG STREQUAL "clang" AND ARM_TARGET_ARCH_ABI STREQUAL "armv8"))
        set(OpenMP_C_FLAGS "-fopenmp=libomp")
        set(OpenMP_C_LIB_NAMES "omp")
        set(OpenMP_CXX_FLAGS "-fopenmp=libomp")
        set(OpenMP_CXX_LIB_NAMES "omp")
        set(OpenMP_omp_LIBRARY /home/Paddle-Lite/android-ndk-r21e/toolchains/llvm/prebuilt/linux-x86_64/lib64/clang/9.0.9/lib/linux/aarch64/libomp.a)
        set(OpenMP_C_FLAGS_WORK "-fopenmp=libomp")
        set(OpenMP_C_LIB_NAMES_WORK "omp")
        set(OpenMP_CXX_FLAGS_WORK "-fopenmp=libomp")
